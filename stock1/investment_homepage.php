...
echo '<html lang="zh-CN"> <meta charset="utf-8" http-equiv="Content-Type" content="text/html;"><title>投资</title><head><link rel="shortcut icon" href="/favicon.ico">';
...
echo '</a></td></tr></table>';
echo '<h1 align="center" style="color:red">投  资</h1>';
echo '<br/><br/><br/><br/><br/><br/>';
echo "<table cellpadding='10' cellspacing='20'><tr><td width='30%'><h2><a  target='_blank' href='/stock1/user_stock.php' style='text-decoration:none;'>自选</a></h2>";
echo "</td><td width='30%'><h2><a  target='_blank' href='/stock1/px.php' style='text-decoration:none;'>排序</a></h2>";
echo "</td></tr><tr><td width='30%'><h2><a  target='_blank' href='/stock1/hy.php' style='text-decoration:none;'>行业</a></h2>";
echo "</td><td width='30%'><h2><a  target='_blank' href='/stock1/hg.php' style='text-decoration:none;'>宏观</a></h2>";
echo "</td></tr><tr><td  width='30%'><h2><a  target='_blank' href='/stock1/jg.php' style='text-decoration:none;'>荐股</a></h2>";
echo "</td><td width='30%'><h2><a  target='_blank' href='/stock1/yd.php' style='text-decoration:none;'>阅读</a></h2></td></tr></table>";
if ($name=='Jiangang'){
