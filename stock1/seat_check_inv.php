<?php
   ...
   if ($result){
      echo "<script>window.location.replace('/stock1/seats_inv.php')</script>";
       echo "<html lang='zh-CN'><meta charset='utf-8'><body><a style='text-decoration:none;'
    href='/stock1/seats_inv.php'>，恭喜！选座成功。请点击返回。</a></body></html>";
   }else{
       echo "<html lang='zh-CN'><meta charset='utf-8'><body><a href='/stock1/seats_inv.php' style='text-decoration:none;'>系统出现问题，请重试。</a></body></html>";
   }
   }
?>
