...
<div class="main_cat">
  <div class="box">
    <div class="site-list shadow">
      <h2 id="2385">房产行业网站</h2>
      <ul class="clearfix">
        <li><a href="http://homelink.com.cn" target="_blank" class="">链家在线</a></li>
        <li><a href="http://www.5i5j.com/loading" target="_blank" class="">我爱我家</a></li>
        <li><a href="http://beijing.anjuke.com" target="_blank" class="">安居客</a></li>
        <li><a href="http://www.century21cn.com" target="_blank" class="">21世纪不动产</a></li>
        <li><a href="http://www.eju.com" target="_blank" class="">易居购房网</a></li>
        <li><a href="http://www.taofang.com" target="_blank" class="">淘房网</a></li>
        <li><a href="http://house.sina.com.cn" target="_blank" class="">新浪乐居</a></li>
        <li><a href="http://focus.cn" target="_blank" class="">焦点房产</a></li>
        <li><a href="http://soufun.com" target="_blank" class="">搜房网</a></li>
        <li><a href="http://house.china.com.cn" target="_blank" class="">地产中国网</a></li>
      </ul>
    </div>
  </div>
</div>
