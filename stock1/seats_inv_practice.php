...
echo "<table width='100%' boder='0'><tr><td align='left'><a class='s2' style='color:#9D9D9D;' href='/stock1/homepage.php' style='text-decoration:none;'>回到首页</a></td><td align='right' style='line-height:1;'><a  style='color:#A1A1A1;' href='/stock1/user_homepage.php'>我的空间</a></td></tr></table><div align=''center'>";
    ?>
<br/>
   <form method="POST" action="/stock1/seat_check_inv_practice.php">
   <h2 style="color:red;">讲&nbsp&nbsp台</h2><div align='center'>
...
<?php echo @$_POST["seat"];?>
<br/><br/>
<input size=18 style="font-size:18px;" onclick="if(document.getElementById('seat').value==''){alert('还没有选择!');window.location.replace('/stock1/seats_inv_practice.php');}" type="submit" size=10 value="提交">
</form>
