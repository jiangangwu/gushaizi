...
$page='disertation_undergraduate';

$name=@$_GET['name'];
$name1=@$_COOKIE['name'];
if ($name=='') {$name=$name1;}
echo '<html lang="zh-CN"> <meta charset="utf-8" http-equiv="Content-Type" content="text/html;"><title>本科论文</title><head><link rel="shortcut icon" href="/favicon.ico">';
...
?>
<h1 style="color:red" align="center">本科论文</h1><br/>
<?php
if ($name!=""){
