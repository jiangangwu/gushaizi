...
echo '<h2 style="color:red" align="center">给网站留言</h2><small><br/><a style="color:#A1A1A1;" href="#liuyan">留言</a><br/></small><br/>';
echo $name;
if ($name!=""){
    ...
    while ($arr=mysql_fetch_array($result)){
        ...
        echo '</td></tr></table><br/>';
        if ($name === $arr[1] and $name!='建刚' and $name!="匿名用户"){
            echo
    ...
    echo $page;
    echo '.php"><div id="liuyan" align="center"><input type="text" name=topic placeholder="请输入标题" style="width:280px;height:30px;font-size:18px;vertical-align:middle ;float left;"/> ';
    echo '</div><p align="center"><font size="9px"> <textarea style="font-size:16px;" align="center" rows="12" name="message" cols="35"></textarea></font></p>';
    echo '<p>';
