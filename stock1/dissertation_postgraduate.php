...
$page='dissertation_postgraduate';

$name=@$_GET['name'];
$name1=@$_COOKIE['name'];
if ($name=='') {$name=$name1;}
echo '<html lang="zh-CN"> <meta charset="utf-8" http-equiv="Content-Type" content="text/html;"><title>论文指导</title><head><link rel="shortcut icon" href="/favicon.ico">';
...
?>
<h2 style="color:red" align="center">论文指导</h2><small><br/><a style="color:#A1A1A1;" href="#liuyan">留言</a><br/></small><br/>
<?php
if ($name!=""){
