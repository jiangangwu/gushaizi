...
<h2 style="color:red" align="center">论文指导</h2><small><br/><a style="color:#A1A1A1;" href="#liuyan">留言</a><br/></small><br/>
       <div align='center'> 2017年春季学期坐班时间
<br/><br/>
地点：经管学院412 
<br/><br/>
	...
	$arr2=mysql_fetch_array($result2);
     if($message==""){
      ...
      //   echo "<script>alert('您的留言重复了！或者不要重复提交。')</script>";
         ...
         if ($result4)echo "<script>window.location.replace('/stock1/research.php')</script>"; else echo "留言失败，可能服务器暂时不响应，请返回重试！";
     }
